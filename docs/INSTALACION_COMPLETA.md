...
## 15. Recomendaciones para publicacion en GitHub

1. Mantener este documento versionado junto al codigo.
2. Actualizar esta guia cuando cambie el template o puertos.
3. Referenciar este archivo desde el README principal.
4. Evitar documentar credenciales reales en texto plano.

---

Si quieres, se puede agregar una segunda guia corta para usuarios no tecnicos con solo 10 comandos y capturas de pantalla.
